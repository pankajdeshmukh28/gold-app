...
echo "  - run once immediately (RunAtLoad)"
echo "  - then once per day at 09:15 local time"
echo "    (if the Mac is asleep at 09:15, it fires on next wake)"
echo ""
echo "Want a different time? Edit 'Hour' / 'Minute' in:"
echo "  $TEMPLATE"
